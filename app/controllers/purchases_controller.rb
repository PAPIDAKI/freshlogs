class PurchasesController < ApplicationController
  ...
  def destroy
    @purchase.destroy
    respond_to do |format|
      format.html { redirect_to tenant_purchases_path, notice: 'Purchase was successfully destroyed.' }
  ...
  private
    ...
    def purchase_params
      params.require(:purchase).permit(:price,:analysis, :note, :tenant_id, :pmu_id,:date)
    end
end
